...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      "These extensions use the Model Context Protocol (MCP). They can expand CodyNo's capabilities using three main components: Prompts, Resources, and Tools. {searchShortcut} to search.",
  },
  defaultNote: {
          ...
          <div className="flex flex-col page-transition">
            ...
            <div className="flex gap-4 mb-8">
              ...
              <Button
                className="flex items-center gap-2 justify-center"
                variant="secondary"
                onClick={() => window.open('https://codyno.dev', '_blank')}
              >
                <GPSIcon size={12} />
