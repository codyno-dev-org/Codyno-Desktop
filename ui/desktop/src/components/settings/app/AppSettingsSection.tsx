...
const i18n = defineMessages({
  ...
  appearanceDesc: {
    ...
    defaultMessage: 'Configure how CodyNo appears on your system',
  },
  ...
  taskNotificationsDesc: {
    ...
    defaultMessage: 'Notify when CodyNo finishes a task while the window is in the background',
  },
  menuBarIcon: { id: 'settings.menuBarIcon.title', defaultMessage: 'Menu bar icon' },
  menuBarIconDesc: {
    id: 'settings.menuBarIcon.description',
    defaultMessage: 'Show CodyNo in the menu bar',
  },
  dockIcon: { id: 'settings.dockIcon.title', defaultMessage: 'Dock icon' },
  dockIconDesc: { id: 'settings.dockIcon.description', defaultMessage: 'Show CodyNo in the dock' },
  preventSleep: { id: 'settings.preventSleep.title', defaultMessage: 'Prevent Sleep' },
  preventSleepDesc: {
    id: 'settings.preventSleep.description',
    defaultMessage:
      'Keep your computer awake while CodyNo is running a task (screen can still lock)',
  },
  ...
  themeDesc: {
    ...
    defaultMessage: 'Customize the look and feel of CodyNo',
  },
  languageTitle: { id: 'settings.language.title', defaultMessage: 'Language' },
  languageDesc: {
    id: 'settings.language.description',
    defaultMessage: 'Choose the display language for CodyNo',
  },
  ...
  helpDesc: {
    ...
    defaultMessage: 'Contact CodyNo about issues or feature requests',
  },
  ...
  updatesDesc: {
    ...
    defaultMessage: 'Check for and install CodyNo updates',
  },
  ...
  notificationsMacStep3: {
    ...
    defaultMessage: 'Find and select CodyNo in the application list',
  },
        ...
        <Card className="rounded-lg">
          ...
          <CardContent className="pt-4 px-4">
            <div className="flex items-center gap-3">
              <span className="text-2xl font-semibold tracking-tight text-text-primary">CodyNo</span>
