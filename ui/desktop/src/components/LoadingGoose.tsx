...
const i18n = defineMessages({
  ...
  thinking: {
    ...
    defaultMessage: 'CodyNo is thinking…',
  },
  streaming: {
    id: 'loadingGoose.streaming',
    defaultMessage: 'CodyNo is working on it…',
  },
  waiting: {
    id: 'loadingGoose.waiting',
    defaultMessage: 'CodyNo is waiting…',
  },
  compacting: {
    id: 'loadingGoose.compacting',
    defaultMessage: 'CodyNo is compacting the conversation...',
  },
  idle: {
