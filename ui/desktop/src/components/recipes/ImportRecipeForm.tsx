...
const i18n = defineMessages({
  ...
  deeplinkPlaceholder: {
    ...
    defaultMessage: 'Paste your codyno://recipe?config=... deeplink here',
  },
  deeplinkHint: {
    id: 'importRecipeForm.deeplinkHint',
    defaultMessage: 'Paste a recipe deeplink starting with "codyno://recipe?config="',
  },
  or: {
  ...
  reviewWarning: {
    ...
    defaultMessage: 'Ensure you review contents of recipe files before adding them to your CodyNo interface.',
  },
  cancel: {
...
const importRecipeSchema = z
  .object({
    deeplink: z
      .string()
      .refine(
        (value) => !value || value.trim().startsWith('codyno://recipe?config='),
        'Invalid deeplink format. Expected: codyno://recipe?config=...'
      ),
    recipeUploadFile: z
      .instanceof(File)
      .nullable()
