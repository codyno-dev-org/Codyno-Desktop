...
- *(goose-agent)* add tool calling ([#11627](https://github.com/codyno-dev-org/Codyno-Desktop/pull/11627))
...
- move inference operation into goose-agent ([#11294](https://github.com/codyno-dev-org/Codyno-Desktop/pull/11294))
