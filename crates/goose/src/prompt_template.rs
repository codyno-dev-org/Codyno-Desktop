...
static TEMPLATE_REGISTRY: &[(&str, &str)] = &[
    (
        "system.md",
        "Main system prompt that defines CodyNo's personality and behavior",
    ),
    (
        "compaction.md",
    ...
    (
        "apps_create.md",
        "Prompt for generating new CodyNo apps based on the user instructions",
    ),
    (
        "apps_iterate.md",
        "Prompt for updating existing CodyNo apps based on feedback",
    ),
    (
        "permission_judge.md",
